     ...
     $(document).on('click', '.delete', function(){
      ...
      else
      {
       return false; 
        ...
        // ESTE CÓDIGO ME PERMITE SELECCIONAR DEPARTAMENTO>MUNICIPIO>FINCA  PARA RELACIONARLOS AL INSERT{
...
//SELECIONA EL ID DE LA FINCA LO ENVIA AL INPUT PARA PASARLO AL ARCHIVO QUE OBTENDRÁ LOS DATOS
  ...
  //SELECIONA EL ID DE LA FINCA LO ENVIA AL INPUT PARA PASARLO AL ARCHIVO QUE OBTENDRÁ LOS DATOS PARA REALIZAR LA CONSULTA
     ...
     var id_finc_id = $("#id_finca_add_id").val(var_request_archivos); //asignarle al input el id de la finca para que lo tome como consulta hacia la db                
      // $('#poligon_add').modal('open');  //abrir el  modal para ejecutar las operaciones
    	       ...
    	       //AGREGARLE EL POLIGONO O IFRAME DE LA FINCA EN MYSQL CON LA URL
    ...
    //VER POLIGONOS ASIGNADOS A LA FINCA
    ...
    $.ajax({
        ...
        //VER LOS ARCHIVOS QUE TIENE LA FINCA
    ...
    //ELIMINAR LOS ARCHIVOS QUE ESTÁN RELACIONADOS CON LAS FINCAS
    ...
    //ELIMINAR LOS URL DE ARCGIS QUE ESTÁN RELACIONADOS CON LAS FINCAS
    $(document).on('click', '.elimin_poligon_f', function(){
      ...
      else
      {
       return false; 
    	       ...
    	       //SELECCIONAR SIEMBRAS PARA AGREGARLOS A UNA FINCA
    ...
    $(document).on('click', '.ver_siem_asignadas', function(){  
        ...
        //ELIMINAR SIEMBRAS RELACIONADAS CON CULTIVOS
