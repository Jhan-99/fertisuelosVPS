...
<head>
    ...
    <title>Fertil | Documentacion</title>
    <!-- Favicons-->
        ...
        <section id="content">
            ...
            <div class="container">
              <div class="row">
                <div class="col s10 m6 l6">
                  <h5 class="breadcrumbs-title">Documentacion del usuario</h5>
                  <ol class="breadcrumbs">
                    <li><a href="../../index.php">Dashboard</a></li>
                    <li><a href="#">Documentacion</a></li>
                    <li class="active">Guia de usuario</li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <div class="section">
              ...
              <!--DataTables example-->
              <div class="row">
                  <p>Este espacio podrás encontrar toda la documentacion necesaria sobre el uso de la aplicación Fertisuelos</p>
                </div>
              <br>
              <div class="divider"></div>
