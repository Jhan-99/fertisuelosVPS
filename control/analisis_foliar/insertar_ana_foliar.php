...
if(isset($_POST["Nombre_programa"]))  
 {  
      ...
      $sql = "INSERT INTO cabecera_foliar(id_cabecera,Nombre_programa,Propietario,Asistente_tecnico,Fecha_muestreo,Fecha_recepcion,Momento_muestreo,Siembra_id,Departamento,Municipio,Finca) VALUES ('".$codcab."','".$Nombre_programa."','".$Propietario."', '".$Asistente_tecnico."', '".$Fecha_muestreo."'
      ,'".$Fecha_recepcion."','".$Momento_muestreo."','".$id_siembra."','".$Departamento."','".$Municipio."','".$Finca."')";  
