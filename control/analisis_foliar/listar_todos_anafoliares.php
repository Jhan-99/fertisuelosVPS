...
$query = '';
$output = array();
$query .= "SELECT * FROM cabecera_foliar ";
...
$sub_array[] = '
<a href="#" name="view" id="'.$row["id_cabecera"].'" class="tooltipped ver_vars_ana" data-position="left" data-delay="50" data-tooltip="Ver resultados"><i class="material-icons green-text center">remove_red_eye</i></a>  '; 
