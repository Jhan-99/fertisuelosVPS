    ...
    if(isset($_POST["operacion"]))
    {
     ...
     if($_POST["operacion"] == "Editar")
     {
      $statement = $connection->prepare(
       ...
       SET Nombre_programa = :Nombre_programa, Propietario = :Propietario, Asistente_tecnico = :Asistente_tecnico, Fecha_muestreo = :Fecha_muestreo, Fecha_recepcion = :Fecha_recepcion, Cultivo_id = :Cultivo_id,
