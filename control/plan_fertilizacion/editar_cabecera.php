...
if(isset($_POST["Nombre_programa"]))  
 {  
      ...
      $sql = "UPDATE cabecera_suelo SET Nombre_programa='$Nombre_programa',Propietario='$Propietario',Asistente_tecnico='$Asistente_tecnico',
      Fecha_muestreo='$Fecha_muestreo',Fecha_recepcion='$Fecha_recepcion',Cultivo_id='$id_cultivo',
