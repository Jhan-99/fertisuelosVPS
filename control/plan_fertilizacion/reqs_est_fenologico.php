...
//cargar los reuerimientos nutricionales para el cultivo según el estado fenológico
 ...
 {  
      ...
      $query = "SELECT u.id_elemento, u.estado_feno, u.id_cultivo, u.N, u.P, u.K, u.Mg, u.Ca, u.Zn, u.Br FROM req_nutri_est_fenolo_cult u  WHERE id_cultivo = '".$_POST["cod_siembra"]."' AND estado_feno = '".$_POST["est_fenologico"]."' "; 
