...
// Trending line chart data	 
	...
	var data = {
		labels: ["Guayaba", "Pitahaya", "Mora", "Durazno", "Gulupa", "Banano", "Lulo"],
		datasets: [{
				label: "First dataset",
	...
	var radarChartData = {
		labels: ["Guayaba", "Durazno", "Mora", "Pitahaya", "Mora"],
		datasets: [{
			label: "First dataset",
...
$(window).on('load', function() {	
	...
	//Tost notification
	setTimeout(function() {
		Materialize.toast('<span>Bienvenido a fertisuelos.</span>', 1500);
	}, 1500);
	setTimeout(function() {
		Materialize.toast('<span>Explora sus funciones!</span>', 3000);
	}, 5000);
	setTimeout(function() {
		Materialize.toast('<span>Nuevas funciones.</span><a class="btn-flat yellow-text" href="#">Ver<a>', 3000);
	}, 15000);
});
